...
/** Invalid/missing preference defaults dark; OS preference never overrides REQ-9.1. */
export function resolveInitialTheme(stored: string | null, _prefersDark: boolean): Theme {
  if (isTheme(stored)) return stored;
  return 'dark';
}

/** A stored/toggled choice wins in both directions. */
