...
**จุดเริ่ม (v1.6):** Phase 0–4 ส่งมอบแล้ว; Phase 5 stage 1–3 ส่งมอบแล้ว → งานถัดไป = **stage 4 (Task Graph + planning gate, §11.2) ตาม §14** · เมื่อพบความไม่ตรงกับพฤติกรรมจริงของ Claude Code/SDK: บันทึก `docs/DEVIATIONS.md` ตาม §0.6
