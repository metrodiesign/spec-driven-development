...
**จุดเริ่ม (v1.9):** Phase 0–4 ส่งมอบแล้ว; Phase 5 stage 1–4 ส่งมอบแล้ว; v1.9 = แยกเคสสร้างไฟล์ใหม่ออกจากการเขียนทับใน write-provenance gate (ไม่ใช่ stage ใหม่ ไม่ขยับ roadmap เช่นเดียวกับ v1.8 ก่อนหน้า) → งานถัดไป = **stage 5 (Evidence backflow) ตาม §14 ตามเดิม** · เมื่อพบความไม่ตรงกับพฤติกรรมจริงของ Claude Code/SDK: บันทึก `docs/DEVIATIONS.md` ตาม §0.6
