...
**จุดเริ่ม (v1.8):** Phase 0–4 ส่งมอบแล้ว; Phase 5 stage 1–4 ส่งมอบแล้ว; v1.8 = แก้ context builder ให้ตรงสัญญา §6.1 (ไม่ใช่ stage ใหม่ ไม่ขยับ roadmap) → งานถัดไป = **stage 5 (Evidence backflow) ตาม §14 ตามเดิม** · เมื่อพบความไม่ตรงกับพฤติกรรมจริงของ Claude Code/SDK: บันทึก `docs/DEVIATIONS.md` ตาม §0.6
