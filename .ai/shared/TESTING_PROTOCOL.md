...
ใช้ระยะเยื้องตาม owner: root metadata/Evidence สองช่อง, child metadata/Evidence สี่ช่อง
และรายการผลลึกกว่า owner อีกสองช่อง. เว้นบรรทัดก่อน `Evidence:`. ตัวอย่างนี้เป็น
placeholder แสดงรูปแบบ ไม่ใช่หลักฐานว่างานจริงผ่าน:

```markdown
- [x] 1. <ชื่องาน>
  - Satisfies: REQ-1.
  - Verify: <คำสั่งตรวจรวมของ root>.

  - [x] 1.1 <ขั้นตอนย่อย>
    - Satisfies: REQ-1.1.
    - Verify: <คำสั่งตรวจ child>.
  ...
  - Evidence:
    - test: `<คำสั่งตรวจรวมจริง>` -> <ผลที่สังเกต>
